...
Each flow contains network metrics such as throughput, bandwidth, retransmit count, and source and destination information down to the IP, port, and PID levels.
